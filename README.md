# Modern URL Shortener & Link Analytics

Fast, reliable URL redirection service and link management utility built with Django featuring slug generation, visit counts, and redirection analytics.
...
- **Technologies**: Django 4+, SQLite, HTML5, CSS3, Python 3.11
- **Lead Developer**: MASA
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/XREFS0/masa-django-url-shortener.git
   cd masa-django-url-shortener
   ```
